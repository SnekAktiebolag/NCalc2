...
namespace NCalc
{
    public class Expression
    {
		...
		public Expression(string expression, CultureInfo cultureInfo) : this(expression, EvaluateOptions.None, CultureInfo.CurrentCulture)
		{
            CultureInfo = cultureInfo;
		}

		public Expression(string expression, EvaluateOptions options) : this(expression, EvaluateOptions.None, CultureInfo.CurrentCulture)
		{
		}
        ...
        public Expression(LogicalExpression expression, EvaluateOptions options) : this(expression, EvaluateOptions.None, CultureInfo.CurrentCulture)
		{ }
